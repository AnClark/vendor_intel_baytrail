...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/init.rc:root/init.minnowboard_max.rc \
    $(LOCAL_PATH)/init.recovery.rc:root/init.recovery.minnowboard_max.rc \
    $(LOCAL_PATH)/ueventd.rc:root/ueventd.minnowboard_max.rc \
...
##############################################################
# Source: device/intel/mixins/groups/boot-arch/minnowboard_max_mmc/product.mk.1
##############################################################
TARGET_UEFI_ARCH := x86_64

##############################################################
# Source: device/intel/mixins/groups/boot-arch/minnowboard_max_mmc/product.mk
##############################################################
